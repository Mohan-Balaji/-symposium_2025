...
function Mlshowdown() {
  ...
  const handleClick = () => {
    ...
    window.scrollTo(0, 0); // Ensure the navbar is visible
  };
  

  return (
    <div className="w-full min-h-screen flex flex-col items-center px-6 md:px-16 lg:px-28 text-white z-20"  key={key}>
