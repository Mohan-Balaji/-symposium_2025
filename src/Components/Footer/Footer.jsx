            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 text-3xl">
                <div className="md:flex md:justify-between flex-wrap">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center md:text-left">
                        <div>
                            <h2 className="mb-4 font-extrabold font-[titleBold] text-gray-900 uppercase dark:text-white text-1xl sm:text-3xl px-15 ">Faculty Coordinators</h2>
                        ...
                        <div>
                            <h2 className="mb-4 font-extrabold font-[titleBold] text-gray-900 uppercase dark:text-white text-1xl sm:text-3xl px-15 md:text-center  ">Students Coordinators</h2>
                        ...
                        <div>
                            <h2 className="mb-4 font-extrabold font-[titleBold] text-gray-900 uppercase dark:text-white text-1xl  sm:text-3xl  px-16 md:text-end ">Follow Us</h2>
